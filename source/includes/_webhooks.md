...
<aside class="notice">
The returned <code>pdf_url</code> or <code>png_url</code> will expire in 24 hours, you should download from the url first if you'd like to use it later, just don't treat it as a permanent link.
</aside>
